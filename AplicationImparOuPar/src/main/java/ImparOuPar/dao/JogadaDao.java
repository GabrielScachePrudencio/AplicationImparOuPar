...
public class JogadaDao {
    ...
    private Jogada determinarVencedor(Jogada jogada1, Jogada jogada2, int resultado) {
        ...
        if (ehPar) {
            if (jogada1.getEscolha().equalsIgnoreCase("Par")) {
                return jogada1;
            }
            if (jogada2.getEscolha().equalsIgnoreCase("Par")) {
                return jogada2;
            }
        } else {
            if (jogada1.getEscolha().equalsIgnoreCase("Impar")) {
                return jogada1;
            }
            if (jogada2.getEscolha().equalsIgnoreCase("Impar")) {
                return jogada2;
            }
        }
